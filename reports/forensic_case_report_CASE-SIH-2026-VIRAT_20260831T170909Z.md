...
**Report Generated (UTC):** `2026-08-31T17:07:46.562325Z`  
...
- **Evidence Root Path:** `C:\Users\Dell\Desktop\ForensicLens\dataset\raw`
- **Analysis Timestamp (UTC):** `2026-08-31T17:07:46.562325Z`
...
|---|---|---|---|---|
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0003.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0007.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0009.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0011.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0013.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0014.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0016.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0017.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0018.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0019.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0021.JPG` | Filesystem creation timestamp recorded. |
| `2026-08-30T12:41:34Z` | `filesystem_created_utc` | `file_created` | `IMG_0022.JPG` | Filesystem creation timestamp recorded. |
...
|---|---|---|---|---|---|
| `coc-000001` | `2026-08-31T17:07:46.562325Z` | `ev-11f452eba4ba48e4` | `evidence_registered` | `source_evidence` | `b6bcfa45dd6b46cf...` |
| `coc-000002` | `2026-08-31T17:07:46.562325Z` | `ev-11f452eba4ba48e4` | `evidence_hashed` | `source_evidence` | `40c08bb122d7dfad...` |
| `coc-000003` | `2026-08-31T17:07:46.562325Z` | `ev-11f452eba4ba48e4` | `evidence_analyzed` | `source_evidence` | `b8e17366824c876c...` |
| `coc-000004` | `2026-08-31T17:07:46.562325Z` | `ev-11f452eba4ba48e4` | `evidence_verified` | `source_evidence` | `26c8e01cb5a1bdd7...` |
| `coc-000005` | `2026-08-31T17:07:46.562325Z` | `ev-785a03f148bb12ce` | `evidence_registered` | `source_evidence` | `96f9e04f0a551bd6...` |
| `coc-000006` | `2026-08-31T17:07:46.562325Z` | `ev-785a03f148bb12ce` | `evidence_hashed` | `source_evidence` | `b578a75d1d887990...` |
| `coc-000007` | `2026-08-31T17:07:46.562325Z` | `ev-785a03f148bb12ce` | `evidence_verified` | `source_evidence` | `d631836a5ae6dbe0...` |
| `coc-000008` | `2026-08-31T17:07:46.562325Z` | `ev-d927bfa9c7a86f18` | `evidence_registered` | `source_evidence` | `afa3986c6797952b...` |
| `coc-000009` | `2026-08-31T17:07:46.562325Z` | `ev-d927bfa9c7a86f18` | `evidence_hashed` | `source_evidence` | `c5ebbca9ce0566c5...` |
| `coc-000010` | `2026-08-31T17:07:46.562325Z` | `ev-d927bfa9c7a86f18` | `evidence_verified` | `source_evidence` | `3b85d2e88fee04cc...` |
